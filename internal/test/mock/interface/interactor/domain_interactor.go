...
func (_m *DomainInteractor) Create(params *public.CreateDomainParams, body *public.CreateDomain) (string, *model.Domain, error) {
	...
	var r1 *model.Domain
	var r2 error
	if rf, ok := ret.Get(0).(func(*public.CreateDomainParams, *public.CreateDomain) (string, *model.Domain, error)); ok {
		return rf(params, body)
	}
...
func (_m *DomainInteractor) Delete(uuid string, params *public.DeleteDomainParams) (string, string, error) {
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(string, *public.DeleteDomainParams) (string, string, error)); ok {
		return rf(uuid, params)
	}
...
func (_m *DomainInteractor) GetById(uuid string, params *public.ReadDomainParams) (string, string, error) {
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(string, *public.ReadDomainParams) (string, string, error)); ok {
		return rf(uuid, params)
	}
...
func (_m *DomainInteractor) Register(xrhid *identity.XRHID, params *public.RegisterDomainParams, body *public.Domain) (string, *header.XRHIDMVersion, *model.Domain, error) {
	...
	var r2 *model.Domain
	var r3 error
	if rf, ok := ret.Get(0).(func(*identity.XRHID, *public.RegisterDomainParams, *public.Domain) (string, *header.XRHIDMVersion, *model.Domain, error)); ok {
...
func (_m *DomainInteractor) Update(xrhid *identity.XRHID, params *public.UpdateDomainParams, body *public.Domain) (string, *header.XRHIDMVersion, *model.Domain, error) {
	...
	var r2 *model.Domain
	var r3 error
	if rf, ok := ret.Get(0).(func(*identity.XRHID, *public.UpdateDomainParams, *public.Domain) (string, *header.XRHIDMVersion, *model.Domain, error)); ok {
		return rf(xrhid, params, body)
	}
