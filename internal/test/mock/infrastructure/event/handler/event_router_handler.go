...
type mockConstructorTestingTNewEventRouterHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEventRouterHandler(t mockConstructorTestingTNewEventRouterHandler) *EventRouterHandler {
