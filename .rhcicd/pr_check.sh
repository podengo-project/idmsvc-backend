...
# --------------------------------------------
APP_NAME="identity-management"  # name of app-sre "application" folder this component lives in
COMPONENT_NAME="idm-domains-backend"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/idm-domains-backend"  # image location on quay
